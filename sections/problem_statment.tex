...
\begin{itemize} %to be presented as from the users perspective.
	\item Provide functionality to perform measurements on the network based on different user-defined fields such latency, signal strength or throughput. %Allow researcher to perfrom measurements. Make it come from the users point of view
	\item Enable the scheduling of network measurements either on demand or at specified time. %change to schedule network measuremetns.
	...
	%Maintain user profiles/ Allow users to maintain user profiles and track their network usage
...
\begin{itemize} %add quesiton on what the question looks at.
	...
	\item Investigate the effectiveness of co-design process for network based web application interface through usability evaluation %put question in itelics
