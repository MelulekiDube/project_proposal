...
%there has to be discussion of the overall system.
%talk in general sense what the project is about.
\begin{figure*}
	%diagram should include mentions for the things we need
	%framework for the collector, visualizor and ochastrator.
	%what the framewrks talk to the dabase through
	%talking to the mobile server.
	%database also needed.
	\begin{center}
